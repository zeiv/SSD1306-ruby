  ...
  class Display
    ...
    def display!
      ...
      for i in (0..@buffer.length).step(16)
        control = 0x40
        @interface.write @address, control, @buffer[i..i+16].pack('c*')
      end
    end
